...
I chose to do the API Calls using async/await because I think the code is self explanatory and simplier and is the modern way of swift programming and concurrency.
